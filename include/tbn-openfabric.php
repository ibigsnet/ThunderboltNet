 ...
 */
function tbn_of_metric_from_mbps($mbps, $reference_mbps = 100000) {
...
function tbn_of_link_metric(array $link, array $icfg, array $gcfg) {
  ...
  $ref = (int)($gcfg['openfabric_metric_reference_mbps'] ?? 100000);
...
function tbn_of_generate_conf(array $gcfg = null) {
  ...
  $lines[] = '! Metric policy: reference_mbps=' . (int)($gcfg['openfabric_metric_reference_mbps'] ?? 100000);
  $lines[] = '!';
...
function tbn_of_status() {
  ...
  return [
    ...
    'metric_reference_mbps' => (int)($cfg['openfabric_metric_reference_mbps'] ?? 100000),
    'ifaces' => $ifaces,
